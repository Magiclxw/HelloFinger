...
{
	HAL_UART_Transmit(&KEYOUT,SLEEP,11,1000);
	Delay_ms(50);
	HAL_UART_Transmit(&KEYOUT,up,11,1000);
}

void CMD_Media_Power(void)
{
	HAL_UART_Transmit(&KEYOUT,Power,11,1000);
	Delay_ms(50);
	HAL_UART_Transmit(&KEYOUT,up,11,1000);
}

void CMD_Media_WakeUp(void)
{
	HAL_UART_Transmit(&KEYOUT,WakeUp,11,1000);
	Delay_ms(50);
	HAL_UART_Transmit(&KEYOUT,up,11,1000);
}
