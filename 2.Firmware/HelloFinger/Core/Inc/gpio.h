...
#define MCU_GPIO_ENCODER_KEY_PIN	GPIO_PIN_1
#define MCU_GPIO_TOUCH_PIN	GPIO_PIN_4
#define MCU_GPIO_KEY1_PIN	GPIO_PIN_8
#define MCU_GPIO_KEY0_PIN	GPIO_PIN_11
#define MCU_GPIO_CH9329_RESET_PIN	GPIO_PIN_12

//GPIOB
#define MCU_GPIO_CH9329_SET_PIN	GPIO_PIN_5
#define MCU_GPIO_ENCODER_SIGNAL_A	GPIO_PIN_6
#define MCU_GPIO_ENCODER_SIGNAL_B	GPIO_PIN_7
