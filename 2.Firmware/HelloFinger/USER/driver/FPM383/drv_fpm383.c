...
/**
*@brief	初始化包头和设备地址，后期可从EEPROM中读取
*@return 执行结果
*/
static void FPM383C_CMD_Init(void)
{
...
*@return 执行结果
*/
int FPM383C_VfyPwd(uint32_t PassWord)				//生成验证口令
{
...
*@return 执行结果
*/
int FPM383C_WriteReg(REG_NUM_e reg,uint8_t value)	//写系统寄存器
{
